...
Date >> //tmp/DFIR_Output/system_information.txt
...
Date >> //tmp/DFIR_Output/running_processes.txt
...
Date >> //tmp/DFIR_Output/active_network_connections.txt
...
Date >> //tmp/DFIR_Output/firewall_settings.txt
...
Date >> //tmp/DFIR_Output/installed_apps.txt
...
Date >> //tmp/DFIR_Output/installed_apps_history.txt
...
Date >> //tmp/DFIR_Output/saved_wifi_profiles.txt
...
Date >> //tmp/DFIR_Output/system_install_logs.txt
...
Date >> //tmp/DFIR_Output/system_LaunchAgents.txt
...
Date >> //tmp/DFIR_Output/system_LaunchDaemons.txt
...
Date >> "//tmp/DFIR_Output/system_cron_jobs.txt"
...
Date >> "//tmp/DFIR_Output/docker_information.txt"
...
Date >> //tmp/DFIR_Output/mac_login_history.txt
...
for user in "${listOfUsersArray[@]}"; do 
    ...
    Date >> "//tmp/DFIR_Output/User_level_files/"$user"_files/"$user"_cron_jobs.txt"
    ...
    Date >> "//tmp/DFIR_Output/User_level_files/"$user"_files/"$user"_Documents_files.txt"
    ...
    Date >> "//tmp/DFIR_Output/User_level_files/"$user"_files/"$user"_Downloads_files.txt"
    ...
    Date >> "//tmp/DFIR_Output/User_level_files/"$user"_files/"$user"_zsh_history.txt"
    ...
    Date >> "//tmp/DFIR_Output/User_level_files/"$user"_files/"$user"_bash_history.txt"
